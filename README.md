...
```javascript
sameKindCasts = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-same-kind-casts@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-same-kind-casts@umd/bundle.js"></script>
```
